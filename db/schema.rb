...
ActiveRecord::Schema.define(version: 2018_10_10_183908) do
  ...
  create_table "houses", force: :cascade do |t|
    t.bigint "real_estate_company_id"
    t.string "location"
  ...
  create_table "real_estate_companies_users", id: false, force: :cascade do |t|
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "house_hunter", default: false
    t.integer "real_estate_company_id"
  ...
  add_foreign_key "houses", "users", column: "realtor_id"
end
